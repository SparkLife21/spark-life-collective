  ...
  return (
    <Section className="py-16 sm:py-24">
      ...
      <div className="mx-auto mt-14 max-w-3xl space-y-12">
        ...
        <section>
          <h2 className="font-serif text-2xl font-light">Tax deductibility</h2>
          <p className="mt-4 text-lg leading-relaxed text-ink/85">
            {site.nonprofitLine}
          </p>
          <p className="mt-3 text-sm italic text-moss">
            [CONFIRM EIN / receipt process with Spark Life before publishing]
          </p>
        </section>

        <section>
          <h2 className="font-serif text-2xl font-light">Where your gift goes</h2>
          <p className="mt-4 rounded-sm border border-dashed border-dusk/50 bg-dusk/10 px-4 py-5 text-ink/80">
            {/* Stub until Spark Life defines allocation. */}
